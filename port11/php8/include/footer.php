    ...
    <div class="container">
        <section class="section_service">
            ...
            <!-- <div class="service last">
                ...
                <ul>
                    <li><span>Portfolio </span> zezihi.com</li>
                    <li><span>E-mail </span> zezihi@naver.com</li>
                    <li><span>KakaoID </span> @zezihi</li>
                    <li><span>Phone </span> 010-4737-7290</li>
                </ul>
            </div> -->
        </section>
        <section class="section_info">
            <h2 class="ir_so">서비스 이용정도</h2>
            <address>&copy;zezihi. All rights reserved.</address>
        </section>
    </div>
